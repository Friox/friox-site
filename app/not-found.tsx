  ...
  return (
    <div className={`${styles.notfound_body}`}>
      <div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
        ...
        <h1 className={`${styles.title} mt-2 text-5xl sm:text-6xl md:text-8xl text-white/90 font-display`}>404 Not Found</h1>
        <h2 className={`${styles.desc} mt-8 text-xl text-white/30`}>I can&apos;t find your destination :(</h2>
